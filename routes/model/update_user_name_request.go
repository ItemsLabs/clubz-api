...
func (m *UpdateUserNameRequest) validateName(formats strfmt.Registry) error {
...
// ContextValidate validates this update user name request based on context it is used
