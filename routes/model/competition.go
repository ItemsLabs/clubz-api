...
// ContextValidate validates this competition based on context it is used
func (m *Competition) ContextValidate(ctx context.Context, formats strfmt.Registry) error {
	return nil
}
